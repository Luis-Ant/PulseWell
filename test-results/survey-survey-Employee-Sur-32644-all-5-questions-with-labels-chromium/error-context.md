...
Locator: getByText('¿Cómo calificarías tu nivel de energía')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('¿Cómo calificarías tu nivel de energía')
...
- main:
  - heading "¡Gracias por responder!" [level=1]
  - paragraph: Tu respuesta fue registrada para el período 2026-W23.
  - paragraph: Tus respuestas son anónimas y se usan de forma agregada. Nunca se comparten de forma individual.
